...
| Advanced configuration | Queue Size | --queueSize QUEUESIZE, -Q QUEUESIZE | The maximum number of chunks to queue for processing (default: 500) |
| Advanced configuration | Thread | --threaded, -T | Run threads instead of processes (for debugging purposes only) (default: False) |
| Advanced configuration | Reference Chunk Size | --referenceChunkSize REFERENCECHUNKSIZE, -C REFERENCECHUNKSIZE | The size of the chunk in terms of how many bases it spans in the reference (default: 500) |
...
| Advanced configuration | Reference Chunk Overlap | --referenceChunkOverlap REFERENCECHUNKOVERLAP | The number of bases of overlap between each chunk, used to stitch chunks together (default: 5) |
...
(optional) A file containing on each line a contig and window coordinates to whitelist for processing.
__Parameters File__
...
## Glossary
* __Chunk Cache?__
  * An internal HDF5 file-handling detail, used to accelerate accesses from h5 files.
